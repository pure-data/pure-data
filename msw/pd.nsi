...
;
; If used without 'build-nsi.sh' use like:
;
; 32bit app from MINGW with the package mingw32-nsis
;
;	makensis -DARCHI=32 pd.nsi 
;
; 64bit app 
;
;	makensis -DARCHI=64 pd.nsi 
;
;
;
; or from windows (untested):
;
;
;	makensis /DARCHI=32 pd.nsi 
;
